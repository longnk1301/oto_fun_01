...
class HomeController extends Controller
{
    ...
    public function postCheckout(Request $request)
    {
        ...
        $advisory->save();
        $data = ['cus_name' => $request->cus_name, 'cus_email' => $request->cus_email];
        // Mail::send('car.blank', $data, function($msg) use ($data) {
        //     $msg->from(env('MAIL_USERNAME'), 'Funcars');
        //     $msg->to($data['cus_email']);
