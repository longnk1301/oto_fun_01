            ...
            <div class="property-fly">
                <table class="table table-bordered table-striped table-hover">
                      <tbody>
                        ...
                        <tr>
                            <th scope="row" class="height-th-left">{{ trans('auth.turn_light') }}</th>
                        </tr>
                        <tr>
                        ...
                        <div>
                            <table class="table table-bordered table-striped table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row" class="height-th">
                                            {{ $car->options->cylinder_capacity }} (mll)
                                        </th>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="height-th">
                                            {{ $car->options->max_capacity }} (round/minute)
                                        </th>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="height-optional">
                                    ...
                                    <tr>
                                        <th scope="row" class="height-th">
                                            {{ $car->options->height }} (cmm)
                                        </th>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="height-th">
                                            {{ $car->options->weight }} (kg)
                                        </th>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="height-th">
                                            {{ $car->options->width }} (cmm)
                                        </th>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="height-th">
                                            {{ $car->options->colc }} (mll)
                                        </th>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="height-th">
