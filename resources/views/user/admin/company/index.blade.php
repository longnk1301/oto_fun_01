                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                   ...
                                   <th>
                                       <a href="{{ route('company.add') }}"" class="btn btn-success Tooltip" data-toggle="modal" data-target="#myModal2">
                            ...
                            <tbody>
                                 @foreach ($companys as $company)
                                    <tr>
                                        ...
                                        <td>{{ $company->com_add }}</td>
                                        <td>{{ $company->com_phone }}</td>
                                        <td>{{ $company->created_at }}</td>
                                        <td>{{ $company->updated_at }}</td>
                                        <td>
                                            <a href="{{ route('company.edit', ['id' => $company->id]) }}" class="btn btn-sm btn-warning Tooltip" data-toggle="modal" data-target="#myModal2">
                                            ...
                                            <a href="javascript:;" onclick="confirmRemove('{{ route('company.remove', ['id' => $company->id]) }}')" class="btn btn-sm btn-danger Tooltip">
