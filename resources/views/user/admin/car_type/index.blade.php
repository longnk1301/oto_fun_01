...
<div class="content-wrapper bg-color">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('auth.car_type') }}</li>
        </ol>
    </section>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                   ...
                                   <th>
                                       <a href="{{ route('car_type.add') }}"" class="btn btn-success Tooltip" data-toggle="modal" data-target="#myModal2">
                            ...
                            <tbody>
                                 @foreach ($types as $type)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('car_type.edit', ['id' => $type->id]) }}" class="btn btn-sm btn-warning Tooltip" data-toggle="modal" data-target="#myModal2">
                                            ...
                                            <a href="javascript:;" onclick="confirmRemove('{{ route('car_type.remove', ['id' => $type->id]) }}')" class="btn btn-sm btn-danger Tooltip">
